...
* Analyze **user engagement and click behavior**
* Measure **Click-Through Rate (CTR)** and **Cost per Click (CPC)**
* Assess **Return on Investment (ROI)** for ad campaigns
* Identify **top-performing ads, age groups, and genders**
* Build a **marketing-ready performance dashboard**
...
* **Facebook Ads Performance Dataset**
* Simulated / exported data from Facebook & Instagram Ads Manager
* Format: CSV
* 🔗 **Dataset Link:**
  [https://www.kaggle.com/datasets/madislemsalu/facebook-ad-campaign)
* Contains campaign-level metrics such as:
...
✔ Built a **professional marketing analytics dashboard**
✔ Gained real-world exposure to **ad campaign evaluation**
✔ Delivered **actionable insights** for business decision-making

---

## 📌 Screenshot
![Dashboard Review](https://github.com/vaishubokare28/FUTURE_DS_02/blob/main/Facebook%20Ads%20Performance%20Dashboard.png)
